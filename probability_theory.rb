...
def random_var_selection(array)
...
10.times do
  ...
  p random_var_selection([*1..6])
end

10.times do
  # Flipping a coin
  p random_var_selection(['heads', 'tails'])
end
...
# If so, return that option.
  # Ex: random_discrete_variable(*[1..4]). The probability is 25% (1/4 = 0.25). We generate a random number, let's say we get 0.7.
...
#
  # Ex: random_discrete_variable(*['Heads', 'Tails']). The probability is 50% (1/2 = 0.5). We generate a random number, let's say we get 0.33.
